 ...
 */
public class AsynImagePageProviderAdapter extends ImagePageProviderAdapter {

    public void setImagePageProviderHandler(ImagePageProviderHandler imagePageProviderHandler) {
        this.imagePageProviderHandler = imagePageProviderHandler;
    }
    ...
    public AsynImagePageProviderAdapter() {
    }
    ...
    public Bitmap getItem(int index, boolean isBack) {
        if (isBack) {
            return imagePageProviderHandler.getItem(index, isBack, imageThumbUrls[imageThumbUrls.length-1-index]);
        } else {
            return imagePageProviderHandler.getItem(index, isBack, imageThumbUrls[index]);
        }
    }
}
